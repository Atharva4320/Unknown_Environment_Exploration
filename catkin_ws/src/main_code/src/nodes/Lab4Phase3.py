...
class Lab3Drive:
    ...
    def __init__(self):
        ...
        self.initStage = True
        self.state = 1
        self.purePursuitDisrupted = False
        ...
        self.initalPose = rospy.Publisher('/initialpose', PoseWithCovarianceStamped, queue_size=5)
        ...
        rospy.sleep(2)
        rospy.Subscriber('/move_base_simple/goal', PoseStamped, self.phase3)
    ...
    def purePursuit(self, msg):
        ...
        while(True):
            ...
            if(dist != "inf" and dist<.3):
                ...
                self.send_speed(0,0)
                self.purePursuitDisrupted = True   
                return
        ...
        #Complete motion by going to target, Pure pursuit not great at that
        self.go_to(trajectoryPoses[len(trajectoryPoses)-1])
    ...
    def phase3(self, msg):
        ...
        if (self.initStage): 
            # Getting the initial position of the robot for Phase 3
        ...
        goal.pose.orientation = self.quat
